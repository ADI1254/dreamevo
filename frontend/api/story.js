 ...
 * Stable query-based endpoint to avoid dynamic-route edge cases.
 */
...
module.exports = async function handler(req, res) {
  ...
  const world = String((req.query && req.query.world) || '').toLowerCase();
  const mood = String((req.query && req.query.mood) || '').toLowerCase();
